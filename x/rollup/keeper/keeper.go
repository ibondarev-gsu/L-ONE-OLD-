...
//func (k Keeper) GetTxCount(ctx sdk.Context) (int64, error) {
//	openKVStore := k.storeService.OpenKVStore(ctx)
//	bz, err := openKVStore.Get([]byte("tx_count"))
//	if err != nil {
//		return 0, err
//	}
//	if bz == nil {
...
//}
//
//func (k Keeper) SetTxCount(ctx sdk.Context, count int64) error {
//	openKVStore := k.storeService.OpenKVStore(ctx)
//	bz := make([]byte, 8)
//	binary.BigEndian.PutUint64(bz, uint64(count))
//	return openKVStore.Set([]byte("tx_count"), bz)
//}
